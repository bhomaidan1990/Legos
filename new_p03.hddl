...
(:objects
    ...
    (:htn
        ...
        (and
            ...
            ; second option
            ; (t12 (Rotate_2x2_loaded_gripper_V2H g_left y_2x2_11))
            ; (t13 (place g_left y_2x2_11 p_10_04))
            ...
            ;=============
            ; first option
            ; (t14 (pick g_left b_2x2_41 no_dir))
            ; (t15 (place g_left b_2x2_41 p_11_04))
            ; second option
            ...
            ;=============
            ; first option
            ; (t16 (pick g_left b_2x2_42 no_dir))
            ; (t17 (place g_left b_2x2_42 p_10_05))
            ; second option
            ; (t16 (Rotate_2x2_loaded_gripper_V2H g_left b_2x2_42))
            ; (t17 (place g_left b_2x2_42 p_10_05))
            ;=============
            ; ID_101 B_3 |
            ;=============
            ; first option
            ; (t18 (pick g_left b_2x4_51 y_plus))
            ; (t19 (place g_left b_2x4_51 p_13_05))
            ; second option
            ; (t18 (pick g_left b_2x4_51 y_minus))
            ; (t19 (place g_left b_2x4_51 p_12_05))
            ;=============
            ; ID_101 B_4 |
            ;=============
            ; (t20 (pick g_left b_2x4_52 y_minus))
            ; first option
            ; (t21 (Rotate_2x4_right_loaded_gripper_V2H_clk g_left b_2x4_52))
            ; (t22 (place g_left b_2x4_52 p_13_06)) 
            ; second option
            ; (t21 (Rotate_2x4_right_loaded_gripper_V2H_Anticlk g_left b_2x4_52))
            ; (t22 (place g_left b_2x4_52 p_13_07))
            ;=============
            ; ID_101 B_5 |
            ;=============
            ; first option
            ; (t23 (pick g_left b_2x2_43 no_dir))
            ; (t24 (place g_left b_2x2_43 p_11_07))
            ; second option
            ; (t24 (Rotate_2x2_loaded_gripper_V2H g_left b_2x2_43))
            ; (t25 (place g_left b_2x2_43 p_11_07))
        )
    )
